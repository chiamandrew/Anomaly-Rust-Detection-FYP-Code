...
def predict_img(net,
    ...
    img_rgb = BasicDataset.preprocess(full_img, scale_factor, is_mask=False)
    #img = full_img.copy()
    ...
    img = np.vstack([img_rgb, entropy_img])
...
if __name__ == '__main__':
    ...
    net = UNet(n_channels=4, n_classes=2) #changed n_channels from 3 to 4
